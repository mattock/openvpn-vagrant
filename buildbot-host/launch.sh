...
docker container run -it --name $IMAGE --network buildbot-net --cap-add NET_ADMIN --sysctl net.ipv6.conf.all.disable_ipv6=0 --env-file=$DIR/env openvpn_community/$IMAGE:$TAG
